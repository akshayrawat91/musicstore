...
{
	header('location:http://localhost:8888/musicstore/admin.html');
	exit();
}
		...
		<div class="wrap">
			...
			<div style="color: black; background-color: white; font-size: 15pt">
				<div class="section group" >
	        		...
	        		<form action='adminWorkSpace.php' method='post'>
						<button name='add' value=''>Add Product</button>
						<br />
						<br />
						<button name='remove' value=''>Remove Product</button>
						<br />
						<br />
						<button name='update' value=''>Update Product</button>
						<br />
						<br />
						<button name='list' value=''>List All Items</button>
						<br />
						<br />
						<button name='feedback' value=''>View Feedbacks</button>
						<br />
					</form>
