		...
		<div class="wrap">
			...
			<div class="top-nav">
				<ul>
					...
					<li class="active1"><a href="albums.php">Albums</a></li>
				...
				<?php
					...
					if(!$con){
						...
						while($row = $result->fetch_assoc()){
							...
							$sql1 = "SELECT album_im FROM album_image WHERE album_id= '".$a_id."'";
							...
							echo '<img class="album" src="data:image/jpeg;base64,'.base64_encode($album_im).'"/>';
							echo '<h3>'.$a_title.'</h3>';
							echo '<h4>'.$a_rating.'</h4>';
							echo '<div class="button"><a href="productpage.php?album=' . $a_title . '">View Songs</a></div>';
						    echo '</div>';
						}
