<?php
    ...
    $sql = "INSERT INTO purchases (purchase_id, user_id, p_date) VALUES ('$cartID', '$userID', CURDATE());";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
		$purchaseItemID = $row['cart_item_id'];
		$songID = $row['song_id'];
        $sql = "INSERT INTO purchase_items (purchase_item_id, purchase_id, song_id) VALUES ('$purchaseItemID', '$cartID', '$songID');";
		$insert = mysqli_query($con, $sql);
    }

    $sql = "DELETE FROM carts WHERE user_id = '$username';";
		...
		<div class="wrap">
			...
			<!---End-header-->
				...
				<div class="content">
                    ...
                    <h2>Your order number is <?php echo $cartID; ?> </h2>
                <div class='cartire-grid-cartinfo'>
                <a href="history.php">Purchase History</a><br><br>
				</div>
                <div class='return'>
